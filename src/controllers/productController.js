...
const { isValidRequestBody, isValid, isValidSize, isValidImage, isValidNumber, isValidPassword, isValidMobile, isValidPlace, isValidPincode } = require('../utils/validation');
